"""
Django settings for akikatest project.
...
SECRET_KEY = '(^@%l=_tdt65v^#if(pv)nxw=&0f!6s==h!ld^f_0t(%8t7b70'
...
WSGI_APPLICATION = 'akikatest.wsgi.application'
